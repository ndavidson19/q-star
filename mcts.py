"""
Most of this training code was created from Andrej Karpathy's llm.c project (https://github.com/karpathy/llm.c/blob/master/train_gpt2.py)
This was just for playing around with my new ideas for model architectures :)
